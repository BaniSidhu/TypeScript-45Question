...
//Q6 Stripping Names
let nameWhiteSpace = " \t Tara Raichand \n"; //\t is for 5 spaces and \n is for line break
...
let names = ["Hashim Kardar", "Haneen Yousuf", "Ayeshay Gull", "Faris Gazi", "Zumar Yousuf", "Salar Sikandar", "Halay Noor", "Jibreel Grewal"];
...
//Q13 Your own array
let planes = ["A380-Airbus", "boeing-777", "Concorde", "Airbus-A340"];
for (let i = 0; i < planes.length; i++) {
    console.log(`i would like to own ${planes[i]} `);
}
//Q14 Guest List 
let guestList = ["Zumar Yousuf ", " Taliya Murad", "Adam-bin-Muhammad", "Jawahraat"];
...
for (let i = guestList.length - 1; i > 1; i--) {
    console.log(`Sorry due to some reason we are cancelling our dinner sorry for in convince mr/mrs ${guestList[i]}`);
    guestList.pop();
}
...
//Q18 visit places
let vistPlace = ["Turkey", "London", "Korea", "Japan", "Chile", "Saudia Arabia", "UAE"];
...
//Q20 print list
let languages = ["Urdu", "English", "Turkish", "Korean", "Punjabi", "Arabic", "Persian"];
...
// Numerical tests
console.log("Equality Test for Numbers: Is num1 == 10? I predict True.");
console.log(num1 == 9);
...
//  item is in an array
console.log("Array Includes Test: Does array include the itemToCheck (3)? I predict True.");
...
//Q29 Favourite fruit
//Check Independent
let favoriteFruits = ["Avocado", "Mango", "Grapes", "kiwi", "Banana"];
...
let fvrtFruit = ["Avocado", "Mango", "Cheeko"];
...
//Q30 Hello Admin
let userNames = ["Admin", "Bassam", "Haddi", "Mohid"];
...
//Q32  Checking Users 
let curr_Users = ["Bassam", "Ali", "Fatima", "Hassan"];
let New_Users = ["Alif", "Sanan", "Dodo", "Hassan"];
...
//Q34 Pizza 
let pizza = ["Home Town ", "Italiano", "Malai boti"];
...
//Q37 large shirt 
function makeshirt(size = "large", message = "I love Typescript", color = "") {
...
let Magicians = ["Salar", "Alizay", "Eva", "Eda"];
...
//Q45 Cars
function cars(nam, model, ...options) {
    let info = {
        "names": nam,
        "model": model
    };
